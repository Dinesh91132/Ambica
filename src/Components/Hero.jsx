    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-8">
      ...
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <p className="text-xl md:text-1xl text-gray-800 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{animationDelay: '400ms'}}>
          ...
          <p className="text-xl md:text-1xl text-gray-800 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{animationDelay: '500ms'}}>The Ambica Foundation has been actively engaged in environmental conservation through its plantation programs. In 2024, under the leadership of Ambica , the foundation launched an ambitious initiative aiming to plant over 5,000 trees to promote a greener future . This effort reflects their commitment to enhancing biodiversity and combating climate change.


One of the notable events was the Mega Tree Plantation Program organized by the Ambica Foundation Charitable Trust. This large-scale event focused on community involvement and environmental awareness, emphasizing the importance of tree planting in ecological restoration. A video documenting this program provides insights into the foundation's dedication to environmental causes.
