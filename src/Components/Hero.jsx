  ...
  return (
    <div className="bg-gray-300 py-16 px-4">
      ...
      <div className="text-center max-w-4xl mx-auto mb-16">
        <h2 className="text-3xl md:text-4xl font-extrabold text-blue-700 mb-6 animate-fadeInUp">Empowering Lives. Igniting Hope.</h2>
        <p className="text-lg md:text-xl text-gray-900 leading-relaxed animate-fadeInUp delay-200">
          At <span className="font-semibold text-blue-800">Ambica Foundation</span>, we stand as a beacon of compassion and action—transforming rural lives through education, healthcare, ambulance support, and women empowerment. We’re committed to building a brighter, healthier, and more equitable future for every underserved individual.
        </p>
      </div>

      {/* About Us Section */}
      <div className="max-w-5xl mx-auto mb-16 text-gray-800">
        <h3 className="text-2xl font-bold text-center text-blue-800 mb-6 animate-fadeInUp">About Ambica Foundation</h3>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        {[
          ...
          { src: "/images/blooddonationhero.png", label: "Blood Donation Camps" },
          { src: "/images/plantationdrive.png", label: "Tree Plantation Drives" }
        ].map((service, idx) => (
          <div
            key={idx}
