...
const Employment = () => {
  return (
    <div className="p-6 bg-gray-300 min-h-screen flex items-center justify-center">
      <motion.div
      ...
      >
        ...
        >
          Explore various <span className="font-bold text-blue-700">Job Openings</span> and{' '}
          <span className="font-bold text-blue-700">Career Paths</span> in the{' '}
          <span className="underline text-red-700">Healthcare</span> and{' '}
          <span className="underline text-indigo-700">Industrial Sectors</span>.
        </motion.p>

        {/* Job Fair Image with decreased size */}
        <motion.div
          whileHover={{ scale: 1.02 }}
          transition={{ type: 'spring', stiffness: 300 }}
          className="mb-6 overflow-hidden rounded-lg cursor-pointer max-w-md mx-auto"
        >
          <img
            src="/images/jobfair.png"
            alt="Job Fair"
        ...
        <motion.h2
          className="text-2xl font-semibold text-primary mt-6 mb-4"
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-4 flex-wrap">
            <img
              src="https://logodix.com/logo/2206403.jpg"
              alt="ICICI Bank"
              className="h-10"
            />
            <img
          ...
          <p className="text-gray-800 mb-4">
            Secured jobs for{' '}
            <span className="font-bold text-black underline">1650+ candidates</span> in the{' '}
            <span className="text-red-700 font-semibold">banking sector</span>.
          </p>

          <p className="text-gray-800 font-medium">
            ✅ Assured over{' '}
            <span className="font-bold text-black underline">3000+ jobs</span> in various{' '}
